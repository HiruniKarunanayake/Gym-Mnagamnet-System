...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Bumz Gym's Equipment List <i class="fa fa-list"></i></h1>
  </div>
      ...
      $equipmentList= Equipment::getAllEquipments($con);
          ...
          echo"<table class='table table-bordered table-striped'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='equipmentform-edit.php?id=".$equipment->getId()."'><i class='fa fa-edit'></i> Edit</a></div></td>
