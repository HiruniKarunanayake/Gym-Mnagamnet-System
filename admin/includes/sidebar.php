...
<div id="sidebar"><a href="#" class="visible-phone"><i class="fas fa-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-users"></i> <span>Manage Members</span> <span class="label label-important"><?php echo Customer::getCustomerCount($con); ?></span></a>
      <ul>
        ...
        <li class="<?php if ($page == 'members-remove') { echo 'active'; } ?>"><a href="member-remove.php"><i class="fas fa-arrow-right"></i> Remove Member</a></li>
        <li class="<?php if ($page == 'members-update') { echo 'active'; } ?>"><a href="member-edit.php"><i class="fas fa-arrow-right"></i> Update Member Details</a></li>
      </ul>
    </li>

    <li class="submenu"> <a href="#"><i class="fas fa-dumbbell"></i> <span>Gym Equipment</span> <span class="label label-important"><?php echo Equipment::getEquipmentCount($con); ?></span></a>
      <ul>
        ...
        <li class="<?php if ($page == 'remove-equip') { echo 'active'; } ?>"><a href="equipment-remove.php"><i class="fas fa-arrow-right"></i> Remove Equipment</a></li>
        <li class="<?php if ($page == 'update-equip') { echo 'active'; } ?>"><a href="equipment-edit.php"><i class="fas fa-arrow-right"></i> Update Equipment Details</a></li>
      </ul>
    </li>
    ...
    <li class="<?php if ($page == 'attendance') { echo 'submenu active'; } else { echo 'submenu'; } ?>"> <a href="#"><i class="fas fa-calendar-alt"></i> <span>Attendance</span></a>
      <ul>
        ...
        <li class="<?php if ($page == 'view-attendance') { echo 'active'; } ?>"><a href="attendance-view.php"><i class="fas fa-arrow-right"></i> View</a></li>
      </ul>
    </li>
    ...
    <li class="<?php if ($page == 'announcement') { echo 'active'; } ?>"><a href="announcement.php"><i class="fas fa-bullhorn"></i> <span class="label label-important"><?php echo Announcement::getAnnouncementCount($con); ?></span>Announcement</a></li>
