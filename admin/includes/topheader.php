  ...
  <ul class="nav right">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="fas fa-user-circle"></i>  <span class="text">Welcome Admin</span><b class="caret"></b></a>
      <ul class="dropdown-menu">
        ...
        <li class="divider"></li>
        <li><a href="../controllers/logout.php"><i class="fas fa-key"></i> Log Out</a></li>
      </ul>
    </li>
    
    <li class=""><a title="" href="../controllers/logout.php"><i class="fas fa-power-off"></i> <span class="text">Logout</span></a></li>
  </ul>
</div> 