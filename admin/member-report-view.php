  ...
  <div class="container-fluid print-container">
    <div class="row-fluid">
     ...
     <div class="widget-content">
                ...
                <table class="table table-bordered table-invoice-full">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><div class="text-center"><?php if($customer->getPlan() == 0) { echo 'NONE';} else {echo $customer->getPlan().' Month/s';} ?></div></td>
                      <td><div class="text-center"><?php echo $customer->getAddress(); ?></div></td>
                      <td><div class="text-center"><?php echo '$'.$customer->getAmount(); ?></div></td>
                      <td><div class="text-center"><?php echo $customer->getAttendanceCount(); ?> Day/s</div></td>
                    </tr>
                  </tbody>
                </table>
                <table class="table table-bordered table-invoice-full">
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="55%"> <div class="text-center"><h4>Last Payment Done:  $<?php echo $customer->getAmount(); ?>/-</h4>
                        <em><a href="#" class="tip-bottom" title="Registration Date" style="font-size:15px;">Member Since: <?php echo $customer->getRegistrationDate(); ?> </a></em> </td>
                        </div>
                    </tr>
                  </tbody>
                </table>
            ...
            <div class="row-fluid">
                <div class="pull-left">
                <h4>Member <?php echo $customer->getFullName(); ?>,<br/> <br/> Membership is currently <?php echo $customer->getStatus(); ?>! <br/></h4><p>Thank you for choosing our services.<br/>- on the behalf of whole team</p>
                </div>
