      ...
      $announcementList= Announcement::manageAnnouncement($con);
          ...
          foreach ($announcementList as $announcement):
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'>".$announcement->getDate()."</div></td>
                <td><div class='text-center'>".$announcement->getMessage()."</div></td>
                <td><div class='text-center'><a href='actions/remove-announcement.php?id=".$announcement->getAnnouncementId()."' style='color:#F66;' ><i class='fas fa-trash'></i> Remove</a></div></td>
