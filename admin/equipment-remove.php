...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fa fa-home"></i> Home</a> <a href="equipment-remove.php" class="current">Remove Equipment</a> </div>
    <h1 class="text-center">Remove Gym's Equipment <i class="fa fa-ban"></i></h1>
  </div>
        ...
        $equipmentList= Equipment::getAllEquipments($con);
          ...
          echo"<table class='table table-bordered table-striped'>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='actions/delete-equipment.php?id=".$equipment->getId()."' style='color:#F66;'><i class='fa fa-trash'></i> Remove</a></div></td>
