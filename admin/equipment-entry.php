...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fa fa-home"></i> Home</a> <a href="#" class="tip-bottom">Equipments</a> <a href="#" class="current">Add Equipments</a> </div>
  <h1>Equipment Entry Form <i class="fa fa-plus-square" aria-hidden="true"></i>
</h1>
</div>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="equipment-add-req.php" method="POST" class="form-horizontal">
          ...
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block blue span8">071 658 1578</span> 
                </div>
            </div>
            <div class="control-group">
